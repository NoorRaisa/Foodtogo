    ...
    if (empty($_POST['c_name']) || empty($_POST['res_name']) || $_POST['email'] == '' || $_POST['phone'] == '' || $_POST['url'] == '' || $_POST['o_hr'] == '' || $_POST['c_hr'] == '' || $_POST['o_days'] == '' || $_POST['address'] == '') {
        ...
        if ($extension == 'jpg' || $extension == 'png' || $extension == 'jpeg') {
            if ($fsize >= 1000000) {
                ...
                $sql = "INSERT INTO restaurant(c_id,title,email,phone,url,o_hr,c_hr,o_days,address,image,location) VALUE('" . $_POST['c_name'] . "','" . $res_name . "','" . $_POST['email'] . "','" . $_POST['phone'] . "','" . $_POST['url'] . "','" . $_POST['o_hr'] . "','" . $_POST['c_hr'] . "','" . $_POST['o_days'] . "','" . $_POST['address'] . "','" . $fnew . "','" . $_POST['location'] . "')";  // store the submited data ino the database :images
                mysqli_query($db, $sql);
                                    ...
                                    <div class="row p-t-20">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="res_name" class="form-control" placeholder="Burger King">
                                            </div>
                                        </div>
                                        <!--/span-->
                                        <div class="col-md-6">
                                    ...
                                    <div class="row p-t-20">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="phone" class="form-control" placeholder="+8801760603954">
                                            </div>
                                        </div>
                                        <!--/span-->
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" name="location" class="form-control form-control-danger" placeholder="Motijhil">
                                                    </div>
                                            </div>
