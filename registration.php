...
if (isset($_POST['submit'])) //if submit btn is pressed
{
   if (
      ...
      } elseif (mysqli_num_rows($check_email) > 0) //check email
      {
         ...
         $mql = "INSERT INTO users(username,f_name,l_name,email,phone,password,address,location) VALUES('" . $_POST['username'] . "','" . $_POST['firstname'] . "','" . $_POST['lastname'] . "','" . $_POST['email'] . "','" . $_POST['phone'] . "','" . md5($_POST['password']) . "','" . $_POST['address'] . "','" . $_POST['location'] . "')";
         mysqli_query($db, $mql);
         ...
         <div class="container">
            ...
            <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
               <ul class="nav navbar-nav">
                  <li class="nav-item"> <a class="nav-link active" href="login.php">Log In <span class="sr-only">(current)</span></a> </li>
                        ...
                        <form action="" method="post">
                           <div class="row">
                              ...
                              <div class="form-group col-sm-6">
                                 ...
                                 <input class="form-control" type="text" name="location" id="example-tel-input-4" placeholder="Location">
                              </div>
                              <div class="form-group col-sm-6">
